...
const Welcome = () => {
  return (
    <div>
      ...
      <iframe src={"https://www.kapwing.com/e/613a64ef8a594000f02a772f&autoplay=1"} width="100%" height="100%"fullscreen autoPlay={true} allow='autoplay' muted=true loop=true id="myVideo" type="video/mp4" />
